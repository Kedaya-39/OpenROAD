...
void serializeGlobals(Archive& ar, RouterConfiguration* router_cfg)
{
  ...
  (ar) & router_cfg->DO_PAE;
  (ar) & router_cfg->DO_PAE_ENHANCE;
  (ar) & router_cfg->PAE_ENABLE_NB_CACHE;
  ...
  (ar) & router_cfg->PAE_W4;
  (ar) & router_cfg->PAE_W5;
  (ar) & router_cfg->PAE_W6;
  (ar) & router_cfg->PAE_W7;
  (ar) & router_cfg->PAE_N_TH;
  (ar) & router_cfg->PAE_I1_S11;
  (ar) & router_cfg->PAE_I1_S12;
  (ar) & router_cfg->PAE_I1_S13;
  (ar) & router_cfg->PAE_I1_S14;
  (ar) & router_cfg->PAE_I1_S15;
  (ar) & router_cfg->PAE_I1_S16;
  (ar) & router_cfg->PAE_I2_S21;
  (ar) & router_cfg->PAE_I2_S22;
  (ar) & router_cfg->PAE_I2_S23;
  (ar) & router_cfg->PAE_I3_S31;
  (ar) & router_cfg->PAE_I6_S61;
  (ar) & router_cfg->PAE_I6_S62;
